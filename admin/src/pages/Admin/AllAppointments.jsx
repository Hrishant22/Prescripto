  ...
  return (
    <div className='w-full max-w-6xl m-5'>
      ...
      <div className='bg-white border border-gray-200 rounded text-sm max-h-[80vh] min-h-[60vh] overflow-y-scroll'>
        <div className='hidden sm:grid grid-cols-[1fr_3fr_1fr_3fr_3fr_1fr_1fr] grid-flow-col px-6 border-b border-gray-200'>
          <p>S.No</p>
          <p>Patient</p>
          <p>Age</p>
          <p>Date & Time</p>
        ...
        {appointments.map ((item, index) => (
          <div className='flex slex-wrap justify-between max-sm:gap-2 sm:grid sm:grid-cols-[1fr_3fr_1fr_3fr_3fr_1fr_1fr] items-center text-gray-500 py-3 px-6 border-b border-gray-200 hover:bg-gray-50' key={index}>
