    ...
    <form onSubmit={onSubmitHandler} className='m-5 w-full'>
      ...
      <div className='bg-white px-8 py-8 border border-gray-200 rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
          ...
          <div className='w-full lg:flex-1 flex flex-col gap-4'>
            <div className='flex-1 flex flex-col gap-1'>
              ...
              <select onChange={(e) => setSpeciality(e.target.value)} value={speciality} className='border border-gray-200 rounded px-3 py-2' name="" id="">
                ...
                <option value="Gynecologiest">Gynecologiest</option>
        ...
        <div>
          ...
          <textarea onChange={(e) => setAbout(e.target.value)} value={about} className='w-full px-4 pt-2 border border-gray-200 rounded' placeholder='Write about doctor' rows={5}/>
        </div>

        <button type='submit' className=' cursor-pointer bg-primary px-10 py-3 mt-4 rounded-full text-white'>Add Doctor</button>
      </div>
    </form>
  )
}
